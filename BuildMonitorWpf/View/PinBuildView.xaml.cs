...
namespace BuildMonitorWpf.View
{
   ...
   public partial class PinBuildView
   {
      ...
      private void PinBuildView_OnMouseDown(object sender, MouseButtonEventArgs e)
      {
         ...
         var buildDefinition = MonitorSettingsContainer.BuildServers.SelectMany(x => x.BuildDefinitions).FirstOrDefault(x => x.Id == pinBuildViewModel.BuildInformation.BuildDefinitionId);
